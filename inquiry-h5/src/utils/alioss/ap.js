...
a.makeDOMException=function(){
    ...
    a.decode=function(f){
        ...
        switch(h){
            ...
            case 2:g=(j(f,e)<<18)|(j(f,e+1)<<12);c.push(String.fromCharCode(g>>16));
            break
        }
    return c.join("")
};
        ...
        a.encode=function(f){
            ...
            switch(f.length-d){
                ...
                case 2:j=(k(f,e)<<16)|(k(f,e+1)<<8);c.push(h.charAt(j>>18)+h.charAt((j>>12)&63)+h.charAt((j>>6)&63)+g);
                break
            }
            return c.join("")
        };
        b.pay=function(d){
            ...
            window.location.href =  '#/alipay?' + '&goto=' + c
            // window.location.replace(window.location.origin + "#/pay?goto="+c)
        };
        b.decode=function(c){
