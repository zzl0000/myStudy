<template>
  ...
  <!-- <a-card class="prescription-card"> -->
    ...
    <div class="operate-group-spc" style="margin-left: 0px;">
      <div class="btns">
        <span class="btns-item btns-item-spc" @click="showRow(1)">多排显示</span>
        <span class="btns-item btns-item-rigth" @click="showRow(2)">单排显示</span>
      </div>
      ...
      <div class="clearBtn" style="margin-left: 15px;background:#1084ff;color:#fff" @click="handlePrescriptionModel">导入模板方</div>
    ...
    >
    <div class="medicine-module" v-if="isMultiRow == 1">
      <!-- 药材回显框 -->
      <div
    ...
    <div class="medicine-module"  v-if="isMultiRow == 2">
       <!-- 药材回显框--单排 -->
     <div class="medicine-item multiDan"  v-for="(item, index) in CMedicineList" v-bind:key="item" :style="index == CMedicineList.length - 1 ? 'margin-bottom:10px' : ''">
        <div class="item-row">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const onSelect = (value, data) => {
        ...
        //     console.log("11111111111111111111111111")
        //     numRef.value.focus();
        //     isMultiRow.value = true
        //   }else{
        //     console.log("22222222222222222222222222222")
        //     numRef2.value.focus();
        //     isMultiRow.value = false
        //   }
        //   setTimeout(() => {
        //     if(isMultiRow.value){
        //       numRef.value.focus();
      ...
      const handleSavePrescriptionModel = (v) => {
        ...
        emit('handleSavePrescriptionModel', props.modelState.znMedicineName);
